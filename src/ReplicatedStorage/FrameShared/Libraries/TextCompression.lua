-- @Author: 1waffle1, Spynaz
-- Compresses text
-- Source: https://devforum.roblox.com/t/text-compression/163637

local TextCompression = {}
...
function TextCompression:Compress(text)
...
function TextCompression:Decompress(text)
	local dictionary = copy(dictionary)
